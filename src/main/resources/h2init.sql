...
CREATE TABLE IF NOT EXISTS subtasks (
  ...
  status varchar(255) DEFAULT 'not started',
  PRIMARY KEY (id),
  UNIQUE KEY sub_task_name (sub_task_name),
...
VALUES ('1.1', 'Tester', 'Test', 1, '2011-11-01', '2011-11-01', 'Omar', '0.5', '0.5', 'delayed');
...
VALUES ('1.1.1', 'Tester', 'Test', 'Test2', 1, '2011-11-02', '2011-11-02', 'Omar', 0.5, 0.5, 'delayed');
